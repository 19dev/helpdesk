		...
		def tickets_list_table(tickets=@tickets, options={})
			content = content_tag :div, class: "table-responsive", id: "tickets_list_div" do
				table_for tickets, html: {class: "table table-striped table-bordered table-hover table-condensed", id: "tickets_list_table"} do
					column title: t("tickets.label.reference"), html: { th: { class: "col-md-1" }  } do |ticket|
				  	link_to ticket.reference, helpdesk.ticket_path(ticket)
				  end
				  column title: t("tickets.label.title"), html: { th: { class: "col-md-3" }  } do |ticket|
				  	link_to ticket.title, helpdesk.ticket_path(ticket)
				  end
				  column title: t("tickets.label.user"), html: { th: { class: "col-md-2" } } do |ticket|
				  ...
				  column title: t("tickets.label.created_at"), html: { th: { class: "col-md-2" } } do |ticket|
				  	created_time(ticket.created_at.to_time)
				  end
				  column title: t("tickets.label.status"), html: { th: { class: "col-md-1" } } do |ticket|
				  	t("tickets.status.#{ticket.status}")
				  end
				  column title: t("tickets.label.assigned"), html: { th: { class: "col-md-2" } } do |ticket|
          ...
          column :close_date, title: t("tickets.label.close_date"), html: { th: { class: "col-md-2" } }
				end
			end
		...
		def ticket_actions_list_table(actions=@actions, options={})
			content = content_tag :div, class: "table-responsive", id: "tickets_list_div" do
				table_for actions, html: {class: "table table-bordered table-condensed", id: "tickets_list_table"} do
				  column title: t("tickets.label.action_user"), html: { th: { class: "col-md-1" } } do |action|
				  	user_mini_avatar(action.user)
				  end
				  column title: t("tickets.label.action_desc"), html: { th: { class: "col-md-5" } } do |action|
				  	"#{user_name(action.user)} #{ticket_action_desc(action)}"
				  end
				  column title: t("tickets.label.action_date"), html: { th: { class: "col-md-2" } } do |action|
